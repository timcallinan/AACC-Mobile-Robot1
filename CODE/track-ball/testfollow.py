...
r1 = 24                             # radius desired (pixels)
tol = 4                             # radius tolerance (pixels)
...
if __name__ == "__main__":
    ...
    color_range = ((0, 200, 200), (10, 255, 255))  # This color range defines the color target (RED)
    while True:
        target = track.colorTarget(color_range)           # generate a target
