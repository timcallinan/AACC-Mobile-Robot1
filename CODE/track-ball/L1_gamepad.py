...
class Gamepad:
    ...
    def __init__(self):
        ...
        print("Gamepad mode:", gamepads)
        if gamepads:
            if 'ESM-9101 1.05' in gamepads:
                pass
            else:
                print('\nGamepad in incorrect mode (need ESM-9101 1.05):', gamepads)
        else:
            print("\nNo gamepad detected.\n")
            return None
            # exit(1)
...
#     gamepad = Gamepad()
    while True:
        ...
        print(myGpData, "\n")                         # print out the data to confirm functionality
        time.sleep(1)
